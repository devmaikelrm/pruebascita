import { 
  operators, clients, appointments, queue, preferences, captchaRequests, cooldowns,
  type Operator, type Client, type Appointment, type Queue, type Preferences, 
  type CaptchaRequest, type Cooldown,
  type InsertOperator, type InsertClient, type InsertAppointment, 
  type InsertQueue, type InsertPreferences, type InsertCaptchaRequest, type InsertCooldown
} from "@shared/schema";
import { db } from "./db";
import { eq, desc, and, lt, gt } from "drizzle-orm";

// Integration: javascript_database - Storage interface for Spanish consular bot
export interface IStorage {
  ...
  updateCaptchaRequest(id: string, updates: Partial<InsertCaptchaRequest>): Promise<CaptchaRequest | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateCaptchaRequest(id: string, updates: Partial<InsertCaptchaRequest>): Promise<CaptchaRequest | undefined> {
